            ...
            <el-form inline label-width="100px" :model="queryInfo" ref="form">
                ...
                <el-form-item label="审核状态"  prop="examState"
                    ><el-select v-model="queryInfo.examState" clearable>
                        ...
                        ></el-option> </el-select
                ></el-form-item>
                <el-form-item label="隐患状态"  prop="dangerState"
                    ><el-select v-model="queryInfo.dangerState" clearable>
                        <el-option label="未处理" value="undeal"></el-option>
                        <el-option label="忽略" value="ignore"></el-option>
                        <el-option label="已处理" value="dealed"></el-option>
                        <el-option label="已生成工单" value="listed"></el-option
                    ></el-select>
                </el-form-item>
            </el-form>
            <DangerTable :data="tableData" @show="show" />
             <el-pagination
...
export default {
    ...
    methods: {
        ...
        show(num){
            ...
            const {dangerDes} =this.tableData.find(val=>val.dangerNum===num);
